...
/**
  ...
  */
class ParquetFilters(schema: MessageType,
  ...
  def this(
    ...
    pushDownStartWith: Boolean,
    pushDownInFilterThreshold: Int,
    caseSensitive: Boolean) = this(
      null,
      pushDownDate, pushDownTimestamp, pushDownDecimal,
  ...
  private val nameToParquetField : Map[String, ParquetPrimitiveField] = {
    ...
    val primitiveFields = getPrimitiveFields(schema.getFields.asScala).map { field =>
      import org.apache.spark.sql.execution.datasources.PushableColumnBackport30.MultipartIdentifierHelper
...
//    case ld: LocalDate => DateTimeUtils.localDateToDays(ld)
  ...
  private val makeEq: PartialFunction[ParquetSchemaType, (Array[String], Any) => FilterPredicate] = {
  ...
  private val makeNotEq: PartialFunction[ParquetSchemaType, (Array[String], Any) => FilterPredicate] = {
    case ParquetBooleanType =>
  ...
  private val makeLt: PartialFunction[ParquetSchemaType, (Array[String], Any) => FilterPredicate] = {
    case ParquetByteType | ParquetShortType | ParquetIntegerType =>
  ...
  private val makeLtEq: PartialFunction[ParquetSchemaType, (Array[String], Any) => FilterPredicate] = {
    case ParquetByteType | ParquetShortType | ParquetIntegerType =>
      (n: Array[String], v: Any) =>
  ...
  private val makeGt: PartialFunction[ParquetSchemaType, (Array[String], Any) => FilterPredicate] = {
    case ParquetByteType | ParquetShortType | ParquetIntegerType =>
      (n: Array[String], v: Any) =>
  ...
  private val makeGtEq: PartialFunction[ParquetSchemaType, (Array[String], Any) => FilterPredicate] = {
    case ParquetByteType | ParquetShortType | ParquetIntegerType =>
      (n: Array[String], v: Any) =>
  ...
  private def convertibleFiltersHelper(predicate: sources.Filter,
  ...
  /**
    ...
    */
  private def createFilterHelper(predicate: sources.Filter,
